...
let TabBar_Title = ["首页","分类","购物车","个人中心"]      //标题
let TabBar_StoryName = ["Home","Classification","ShoppingCar","MineCenter"]  //sb名称（UI)
let TabBar_SelectedImage = ["home_select","class_select","shopingcar_select","minecenter_select"]        //选择的图片
let TabBar_NoSelectedImage = ["home_normal","class_normal","shopingcar_normal","minecenter_normal"]      //未选择图片
