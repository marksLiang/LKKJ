...
extension UIButton {
    ...
    func SearchBtn(target:Any,actionEvent:Selector,placeholder:String,placeholderColor:UIColor=UIColor.gray) ->UIButton   {
        ...
        Searchbtn.frame.size.width=CommonFunction.kScreenWidth*0.7
        Searchbtn.frame.size.height=28
        Searchbtn.layer.masksToBounds=true
        Searchbtn.CornerRadius(cornerRadius: 4, borderColor: UIColor.clear.cgColor, borderWidth: 0)
